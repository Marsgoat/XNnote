...
這邊可以看到 2、5、7、18 跟 2、3、7、18 就是以 18 為結尾的 LIS，<font color="#c2534c">但是整個序列的 LIS 不一定是以 18 為結尾的</font>，說不定不要接 18 的話還可以接得更長(例如在 101 後面多加入 105、120)，所以必須要將每個數當結尾的 LIS 都找出來，找到最長的那個才是整個序列的 LIS。
...
劉嘉傑老師：<br>
大學時期對我很好的一個老師，因為第一堂課老師提到 AlphaGo 的事情，身為棋迷的我下課就忍不住去找老師討論，老師知道我會下棋後居然直接問我要不要跟他以前博士班的指導教授王老師下棋。<br>
王有禮老師：<br>
